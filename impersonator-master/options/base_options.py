...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--data_dir', type=str, default='./p300/data', help='path to dataset')
        ...
        self._parser.add_argument('--images_folder', type=str, default='images', help='images folder')
        ...
        self._parser.add_argument('--model', type=str, default='impersonator_trainer', help='model to run')
