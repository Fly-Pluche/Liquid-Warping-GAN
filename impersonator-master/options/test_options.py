...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--src_path', type=str, default=r'./assets/src_imgs/imper_A_Pose/009_5_1_000.jpg', help='source image path')
        # self._parser.add_argument('--src_path', type=str, default=r'./assets/src_imgs/internet/men1_256.jpg', help='source image path')
        self._parser.add_argument('--tgt_path', type=str, default=r'./assets/samples/refs/iPER/min', help='target image path')
        self._parser.add_argument('--pri_path', type=str, default='./assets/samples/A_priors/imgs',
                                  help='prior image path')
        self._parser.add_argument('--video_path',type=str,default=r'./static/scratch/final',help='path to save final_video')
        self._parser.add_argument('--gif_name',type=str,default=r'./static/scratch/',help='name to save final_video')
        ...
        self._parser.add_argument('--D3D', action="store_true", default=False, help='是否对结果使用D3D超分辨率')
        ...
        self._parser.add_argument('--port', type=int, default=5000, help='visdom port')

        # save results or not
        self._parser.add_argument('--save_res', action='store_true', default=True,
